...
<div class="parent">
    ...
    <div class="holiday-row">
        <div class="holiday-date">March 1, 2025</div>
        <div class="holiday-info">
            <h3>Ramadan Start (Tentative Date)</h3>
            <p>The beginning of the Islamic holy month of fasting, prayer, and reflection.</p>
        </div>
    </div>
    <div class="holiday-row">
        <div class="holiday-date">March 9, 2025</div>
        <div class="holiday-info">
            <h3>Teachers' Day</h3>
            <p>A day to honor and appreciate the contributions of teachers.</p>
        </div>
    </div>
    <div class="holiday-row">
        <div class="holiday-date">March 21, 2025</div>
        <div class="holiday-info">
            <h3>Mother's Day</h3>
            <p>A day to celebrate and honor mothers and motherhood.</p>
        </div>
    </div>
    <div class="holiday-row">
        <div class="holiday-date">March 25, 2025</div>
        <div class="holiday-info">
            <h3>Feast of the Annunciation</h3>
            <p>A Christian holiday celebrating the announcement by the angel Gabriel to the Virgin Mary that she would conceive and become the mother of Jesus.</p>
        </div>
    </div>
    <div class="holiday-row">
        <div class="holiday-date">March 31, 2025</div>
        <div class="holiday-info">
            <h3>Eid al-Fitr (Tentative Date)</h3>
            <p>An Islamic festival marking the end of Ramadan, the holy month of fasting.</p>
        </div>
    </div>
    <div class="holiday-row">
        <div class="holiday-date">April 1, 2025</div>
        <div class="holiday-info">
            <h3>Eid al-Fitr Holiday (Tentative Date)</h3>
            <p>Continuation of the Eid al-Fitr celebrations.</p>
        </div>
    </div>
    <div class="holiday-row">
        ...
        <div class="holiday-info">
            <h3>Good Friday</h3>
            <p>Christian holiday commemorating the crucifixion of Jesus Christ.</p>
        </div>
    </div>
    <div class="holiday-row">
        <div class="holiday-date">April 18, 2025</div>
        <div class="holiday-info">
            <h3>Orthodox Good Friday</h3>
            <p>Observed by Orthodox Christians to commemorate the crucifixion of Jesus Christ.</p>
        </div>
    </div>
    <div class="holiday-row">
        <div class="holiday-date">April 20, 2025</div>
        <div class="holiday-info">
            <h3>Easter Sunday</h3>
            <p>Christian holiday celebrating the resurrection of Jesus Christ from the dead.</p>
        </div>
    </div>
    <div class="holiday-row">
        <div class="holiday-date">April 20, 2025</div>
        <div class="holiday-info">
            <h3>Orthodox Easter Day</h3>
            <p>Celebration of the resurrection of Jesus Christ according to the Orthodox Christian tradition.</p>
        </div>
    </div>
    <div class="holiday-row">
        <div class="holiday-date">April 21, 2025</div>
        <div class="holiday-info">
            <h3>Easter Monday</h3>
            <p>The day after Easter Sunday, observed as a holiday by some Christian denominations.</p>
        </div>
    </div>
    <div class="holiday-row">
        <div class="holiday-date">April 21, 2025</div>
        <div class="holiday-info">
            <h3>Orthodox Easter Monday</h3>
            <p>The day after Orthodox Easter Sunday, observed as a holiday by Orthodox Christians.</p>
        </div>
    </div>
    </div>
</div>
